...
public class Lesson01Quiz02RestController {
	...
	@RequestMapping("/1")
	public List<Map<String,Object>> showListMovie(){
	...
	@RequestMapping("/2")
	public List<Board> showListboard(){
	...
	@RequestMapping("/3")
	public ResponseEntity<Board> showListChosen(){
		List<Board> list = new ArrayList<>();
		...
		for(Board boardCur : list) {
			if(boardCur.getUser().equals("marobiana")) {
				board = boardCur;
			}
		}
